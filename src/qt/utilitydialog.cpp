    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Advance Protocol") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Advance Protocol"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  advance-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Advance in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ADVANCE, 0.1 ADVANCE, 1 ADVANCE and 10 ADVANCE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://advanceprotocol.atlassian.net/wiki/display/DOC/PrivateSend\">https://advanceprotocol.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Advance Protocol is shutting down...") + "<br /><br />" +
