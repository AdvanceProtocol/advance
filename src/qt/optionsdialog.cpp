    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ADVANCE-light"), QVariant("light"));
    ui->theme->addItem(QString("ADVANCE-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("ADVANCE-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ADVANCE-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ADVANCE-traditional"), QVariant("trad"));
