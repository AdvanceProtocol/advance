    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Advance Protocol") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Advance address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and advance: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Advance Protocol"), this);
    aboutAction->setStatusTip(tr("Show information about Advance Protocol"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Advance Protocol"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Advance addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Advance addresses"));
    ...
    openAction->setStatusTip(tr("Open a advance: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Advance Protocol help message to get a list with possible Advance Protocol command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Advance Protocol client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Advance network", "", count));
    } else {
...
{
    QString strTitle = tr("Advance Protocol"); // default title
    ...
    // Append title to "Advance Protocol - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
