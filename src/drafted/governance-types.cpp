...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AdvanceNetwork") type = AdvanceNetwork;
    if(strType == "AdvanceNetworkVariable") type = AdvanceNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AdvanceNetwork) s = "AdvanceNetwork";
    if(type == AdvanceNetworkVariable) s = "AdvanceNetworkVariable";
