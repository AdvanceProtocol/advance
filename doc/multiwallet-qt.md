...
Only requiring some minor changes is advance.cpp.
...
Changes to advance.cpp
----------------------
advance.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
