...
Advance Protocol is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Advance Protocol, where everyone uses
...
pay attention to for reviewers of Advance Protocol code.

General Advance Protocol
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Advance Protocol uses tinyformat, which is type safe. Leave them out to avoid confusion
