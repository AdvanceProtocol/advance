...
This mechanism has been integrated into Bitcore-Node-Advance which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/advanceprotocol/insight-api-advance#web-socket-api](https://github.com/advanceprotocol/insight-api-advance#web-socket-api)
* API: [https://github.com/advanceprotocol/insight-api-advance#instantsend-transactions](https://github.com/advanceprotocol/insight-api-advance#instantsend-transactions)
...
By default, the Advance Protocol daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Advance Protocol daemon:
